        ...
        <div className={classNames(
          ...
          <div className="space-y-8">
            ...
            <div>
              {!collapsed && (
                <div className={classNames(
                  'px-4 py-2 text-xs font-bold uppercase tracking-widest mb-3',
                  darkMode ? 'text-slate-400' : 'text-slate-500'
                )}>
                  <div className="flex items-center space-x-2">
                    <div className="w-1 h-4 rounded-full bg-gradient-to-b from-blue-500 to-blue-600"></div>
                ...
                {navigationItems.map((item) => {
                  ...
                  return (
                    <NavLink
                      ...
                      to={item.href}
                      className={classNames(
                        'group flex items-center text-sm font-medium rounded-xl transition-all duration-300 relative overflow-hidden',
                        collapsed ? 'px-3 py-4 justify-center' : 'px-4 py-3.5',
                        isActive
                          ? 'bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 text-white shadow-xl shadow-blue-500/25 transform scale-[1.02]' 
                          : darkMode 
                    ...
                    >
                      ...
                      {isActive && (
                        <div className="absolute inset-0 bg-gradient-to-r from-blue-600/20 via-blue-500/20 to-blue-600/20 rounded-xl blur-sm"></div>
                      )}
                      
                      <div className={classNames(
                        'flex items-center justify-center rounded-lg transition-all duration-300 relative z-10',
                        collapsed ? 'w-10 h-10' : 'w-8 h-8 mr-4',
                        isActive 
                          ? 'text-white bg-white/10 shadow-lg' 
                          : darkMode 
                            ? 'text-slate-400 group-hover:text-slate-200 group-hover:bg-slate-600/30'
                      ...
                      {!collapsed && (
                        <div className="flex-1 relative z-10">
                          ...
                          {item.emoji && (
                            <span className="ml-2 text-xs opacity-70">{item.emoji}</span>
                          )}
                        </div>
                      )}
